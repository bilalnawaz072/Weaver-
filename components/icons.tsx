...
export const ViewColumnsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-5 h-5 ${className || ''}`}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5v10.5h-16.5V6.75zM9 6.75v10.5m6-10.5v10.5" />
    </svg>
);
...
export const ArrowUturnDownIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-4 h-4 ${className || ''}`}>
...
export const Cog6ToothIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-5 h-5 ${className || ''}`}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226l.043-.018c.22-.1.454-.146.69-.146s.47.046.69.146l.043.018c.55.223 1.02.684 1.11 1.226l.043.252c.29.172.565.38.81.62l.203.203c.43.43.66 1.012.66 1.631v.043c0 .234-.046.468-.146.69l-.018.043c-.223.55-.684 1.02-1.226 1.11l-.252.043a5.993 5.993 0 0 1-.62.81l-.203.203c-.43.43-1.012.66-1.631.66h-.043c-.234 0-.468-.046-.69-.146l-.043-.018c-.55-.223-1.02-.684-1.11-1.226l-.043-.252a5.993 5.993 0 0 1-.81-.62l-.203-.203c-.43-.43-.66-1.012-.66-1.631v-.043c0-.234.046.468.146.69l.018-.043c.223-.55.684-1.02 1.226-1.11l.252-.043c.172-.29.38-.565.62-.81l.203-.203zM12 15.75a3.75 3.75 0 1 0 0-7.5 3.75 3.75 0 0 0 0 7.5z" />
    </svg>
);
...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 ${className || ''}`}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.038-.502.068-.75.098m.75-.098a2.25 2.25 0 0 1 2.25 2.25v5.714a2.25 2.25 0 0 0 .659 1.591L19.8 14.5M16.5 14.5l-2.25 2.25a2.25 2.25 0 0 1-3.182 0l-2.25-2.25m5.636 0M16.5 14.5L12 18.75m4.5-4.25L12 18.75" />
    </svg>
);
...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-5 h-5 ${className || ''}`}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c.401-.42.767-.864 1.126-1.32M12 18.75v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c.401-.42.767-.864 1.126-1.32M12 3.75a6.75 6.75 0 0 1 6.75 6.75c0 3.391-2.25 6.26-5.25 7.152-1.39.333-2.81.333-4.2 0C6.75 16.76 4.5 13.891 4.5 10.5A6.75 6.75 0 0 1 12 3.75Z" />
    </svg>
);
...
export const ViewfinderCircleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-5 h-5 ${className || ''}`}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75H6A2.25 2.25 0 0 0 3.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0 1 20.25 6v1.5m0 9V18A2.25 2.25 0 0 1 18 20.25h-1.5m-9 0H6A2.25 2.25 0 0 1 3.75 18v-1.5M12 12.75a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" />
