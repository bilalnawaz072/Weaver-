...
export const ProjectSettingsModal: React.FC<ProjectSettingsModalProps> = ({ isOpen, onClose, project, customFieldDefinitions, onSaveDefinition, onDeleteDefinition }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-end sm:items-center p-0 sm:p-4" onClick={onClose}>
      <div className="bg-gray-800 rounded-t-xl sm:rounded-xl shadow-2xl w-full max-w-2xl relative border-t sm:border border-gray-700 max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
        ...
        <div className="overflow-y-auto px-6 sm:px-8 pb-6">
