...
import { Node as NodeType, GitHubCreateIssueNodeData, StepExecutionStatus } from '../../../types';
import { BaseNode } from './BaseNode';

interface NodeProps {
    node: NodeType<GitHubCreateIssueNodeData>;
...
export const GitHubCreateIssueNode = forwardRef<HTMLDivElement, NodeProps>((props, ref) => {
    ...
    return (
        ...
        >
            ...
            <p className="text-xs text-gray-400 mt-2 truncate">
                Repo: {node.data.repository || <span className="italic">Not set</span>}
            </p>
